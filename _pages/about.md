...
I'm a Machine Learning Engineer at [Pacific Northwest National Laboratory](https://www.pnnl.gov/), where I work on projects ranging from using LLM's to improve the Enviornmental permitting process to developing simulation codes for improving energy efficiency at Commercial Ports. 

Previously, I completed my PhD in Computational Science and Engineering at Georgia Tech's [College of Computing](https://www.cc.gatech.edu/), advised by [Haesun Park](https://faculty.cc.gatech.edu/~hpark/) and [Richard Vuduc](https://vuduc.org/v2/). My doctoral research was supported by the [DOE Computational Science Graduate Fellowship](https://www.krellinst.org/csgf/).
